    ...
    <div id="login">
      <div id="form">
		...
		<!-- %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% -->
	      ...
	      <input id="Date" type="date" name="Date" placeholder="mm/dd/yyyy" min="2015-08-01" max="2020-10-30" required autofocus> (mm/dd/yyyy)
	    </div>

            <!--Times for scheduling an individual appointment-->
	    <div class="field">
