...
//Find the user in the Students table by ID
    ...
    <div id="login">
      <div id="form">
			...
			<div class="field">
                                ...
                                <!--New student ID text box. Cant change this!-->
			...
			<div class="field">
                                  ...
                                  <!--New major selection field-->
				  <label for="major">Major</label>
				  <select id="major" name = "major">
                                        <option value = "ENGR" <?php if($_SESSION["major"] == 'ENGR'){echo("selected");}?>>Engineering Undecided</option>
